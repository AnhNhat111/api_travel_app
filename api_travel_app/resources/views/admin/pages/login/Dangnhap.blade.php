                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" action="{{ route('admin.login.post') }}"
                                    method="POST">
                                    @csrf
                                ...
                                <p class="mt-5 login-form__footer">Bạn chưa có tài khoản ? <a href=""
                                        class="text-primary">Đăng ký</a> ngay nhé.</p>
                            </div>
                        </div>
                    </div>
                </div>
