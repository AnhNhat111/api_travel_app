        ...
        <ul class="metismenu" id="menu">
            ...
            <li class="mega-menu mega-menu-sm">
                <a class="has-arrow" href="" aria-expanded="false">
                    <i class="icon-speedometer menu-icon"></i><span class="nav-text">User Management</span>
                </a>
            ...
            <li class="mega-menu mega-menu-sm">
                <a class="has-arrow" href="" aria-expanded="false">
                    <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Tour Management</span>
                </a>
                <ul aria-expanded="false">
